...
Connection.prototype.open = function(connectFn, listeners) {
 ...
 *  (clientId, data)
 */
Connection.prototype.addListener = function(clientId, message, listener) {
 ...
 */
Connection.prototype.addListeners = function(clientId, listeners) {
 ...
 */
Connection.prototype.addGroup = function(group, clients) {
 ...
 */
Connection.prototype.addToGroup = function(client, group) {
  if (typeof(groups[group]) == 'undefined') {
 ...
 * @param {String} group - The group identifier
 */
Connection.prototype.removeFromGroup = function(client, group) {
  if (typeof(groups[group]) == 'undefined') {
    return new Error('Group <' + group + '> does not exist');
 ...
 */
Connection.prototype.send = function(client, message, content) {
 ...
 * @param {Object} [content] - The content object to send with the message
 */
Connection.prototype.broadcast = function(sourceClient, group, message, content) {
  if (typeof(content) == 'undefined') {
 ...
 * @param {Object} [content] - The content object to send with the message
 */
Connection.prototype.groupSend = function(group, message, content) {
  if (typeof(content) == 'undefined') {
